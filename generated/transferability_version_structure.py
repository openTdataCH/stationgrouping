...
from generated.shared_usage_enumeration import SharedUsageEnumeration
...
class TransferabilityVersionStructure(UsageParameterVersionStructure):
    ...
    :ivar maximum_number_of_named_transferees: If product can be used by
        a named group , eg  parents of a family, maximum number of named
        holders allowed.
    ...
    :ivar shared_usage: Indicates the nature of the permitted sharing,
        if any,  of products that can be shared, e.g.  trips from a
        multi-trip carnet. +v1.1
    """
